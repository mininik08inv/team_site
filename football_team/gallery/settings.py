...
GALLERY_LOGO_PATH = getattr(settings, 'GALLERY_LOGO_PATH', "gallery/images/AFTambov-logo.png")
# Gallery title in top bar
GALLERY_TITLE = getattr(settings, 'GALLERY_TITLE', "Галерея ")
# Info text in footer
GALLERY_FOOTER_INFO = getattr(settings, 'GALLERY_FOOTER_INFO', "Академия футбола Тамбов 2013")
